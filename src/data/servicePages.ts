...
export const AI_VISIBILITY_SERVICE: ServicePageData = {
  ...
  faq: [
    ...
    { q: 'What does an engagement look like?', a: 'Single-location businesses can start with the fixed-scope AI Visibility Sprint; larger or multi-location sites start with the AI Visibility Audit. Either can move into a focused Enhancements phase, then optional ongoing monitoring. See the tiers below; timelines run roughly 10 business days to 10 weeks to deploy improvements.' },
  ],
};
